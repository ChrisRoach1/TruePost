...
class TokenRefresh implements ShouldQueue
{
     ...
     * Execute the job.
     */
    public function handle(XService $xService, InstagramService $instagramService, LinkedInService $linkedinService, ThreadsService $threadsService): void
    {
        ...
        switch ($this->userToken->System->url_slug) {
            ...
            case 'instagram':
                ...
                break;
            case 'threads':
                $threadsService->refreshToken($this->userToken);
                break;
